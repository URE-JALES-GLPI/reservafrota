...
(function () {
    ...
    function openEditModal(b, bform, csrf, canApprove) {
        ...
        overlay.innerHTML =
          ...
          + '<label class="form-label">Carro (escolhido pelo gestor na aprovação)</label>'
          + '<input type="text" class="form-control" value="' + esc2((b.car_id && b.car) ? b.car : 'A designar pelo gestor') + '" disabled>'
